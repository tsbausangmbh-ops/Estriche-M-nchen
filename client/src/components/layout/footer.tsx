      ...
      <div className="w-full mx-auto px-4 sm:px-20 lg:px-48">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-x-8 gap-y-6">
          <div className="col-span-2 md:col-span-1 lg:col-span-1" data-testid="footer-brand">
            ...
            <p className="text-background/50 text-[10px] leading-relaxed" data-testid="text-footer-description">
              Ihr zuverlässiger Partner für professionelle Estricharbeiten in München und Umgebung.
            </p>
          </div>

          <div data-testid="footer-services">
            <h4 className="font-semibold text-[11px] mb-3 text-background/80">Leistungen</h4>
          ...
          <div data-testid="footer-info">
            <h4 className="font-semibold text-[11px] mb-3 text-background/80">Infos & Preise</h4>
            <ul className="space-y-1.5 text-[11px] text-background/50">
          ...
          <div data-testid="footer-contact">
            <h4 className="font-semibold text-[11px] mb-3 text-background/80">Kontakt</h4>
            <ul className="space-y-1.5 text-[11px] text-background/50">
          ...
          <div data-testid="footer-legal">
            <h4 className="font-semibold text-[11px] mb-3 text-background/80">Rechtliches</h4>
            <ul className="space-y-1.5 text-[11px] text-background/50">
        ...
        <div className="border-t border-background/10 mt-6 pt-4 text-center">
          <p className="text-[8px] text-background/40">
