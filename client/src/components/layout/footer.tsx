    ...
    <footer className="bg-foreground text-background py-6" data-testid="footer">
      <div className="w-full mx-auto px-4 sm:px-20 lg:px-48">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div className="col-span-2 md:col-span-1" data-testid="footer-brand">
            <Link href="/" className="flex items-center gap-2 mb-2">
              ...
              />
              <div>
                <span className="block font-bold" style={{fontSize: '11px'}}>Estriche München</span>
                <span className="block text-background/50" style={{fontSize: '9px'}}>Estrich • Bodenaufbau • Sanierung</span>
              </div>
            </Link>
            <p className="text-background/50" style={{fontSize: '9px'}} data-testid="text-footer-description">
          ...
          <div data-testid="footer-services">
            <h4 className="font-semibold text-background/80 mb-2" style={{fontSize: '10px'}}>Leistungen</h4>
            <ul className="space-y-1 text-background/50" style={{fontSize: '10px'}}>
          ...
          <div data-testid="footer-info">
            <h4 className="font-semibold text-background/80 mb-2" style={{fontSize: '10px'}}>Infos & Preise</h4>
            <ul className="space-y-1 text-background/50" style={{fontSize: '10px'}}>
          ...
          <div data-testid="footer-contact">
            <h4 className="font-semibold text-background/80 mb-2" style={{fontSize: '10px'}}>Kontakt</h4>
            <ul className="space-y-1 text-background/50" style={{fontSize: '10px'}}>
          ...
          <div data-testid="footer-legal">
            <h4 className="font-semibold text-background/80 mb-2" style={{fontSize: '10px'}}>Rechtliches</h4>
            <ul className="space-y-1 text-background/50" style={{fontSize: '10px'}}>
        ...
        <div className="border-t border-background/10 mt-4 pt-3 text-center">
          <p className="text-background/40" style={{fontSize: '8px'}}>
