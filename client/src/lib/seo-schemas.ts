export const businessInfo = {
  ...
  description: "Professionelle Estricharbeiten in München und Umgebung. Fachbetrieb mit 30+ Jahren Erfahrung.",
...
export function generateProfessionalServiceSchema() {
  return {
    ...
    "description": "Professionelle Estricharbeiten in München und Umgebung. Zementestrich, Fließestrich, Heizestrich, Industrieböden vom Fachbetrieb mit 30+ Jahren Erfahrung.",
    "url": businessInfo.url,
    "telephone": businessInfo.telephone,
    "email": businessInfo.email,
    "foundingDate": businessInfo.foundingDate,
