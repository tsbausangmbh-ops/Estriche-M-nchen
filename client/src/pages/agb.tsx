      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-muted-foreground mb-8">
            der Estrich München GmbH für Estrich- und Bodenarbeiten
          </p>
          ...
          <Card className="mb-6">
            <CardContent className="p-6 space-y-8">
              ...
              <div>
                <h2 className="text-xl font-bold mb-3">§ 7 Abnahme</h2>
                <p className="text-muted-foreground">
                  (1) Nach Fertigstellung der Arbeiten erfolgt eine gemeinsame Abnahme. Der Auftraggeber 
                  ist verpflichtet, innerhalb von 12 Werktagen nach Fertigstellungsanzeige die Abnahme 
                  durchzuführen.
                  <br /><br />
                  (2) Die Abnahme gilt als erfolgt, wenn der Auftraggeber die Leistung nutzt oder den 
                  Bodenbelag verlegen lässt, ohne wesentliche Mängel gerügt zu haben.
                  <br /><br />
                  (3) Etwaige Mängel sind bei der Abnahme schriftlich festzuhalten.
                </p>
              </div>
              ...
              <div className="pt-4 border-t">
                <p className="text-sm text-muted-foreground">
                  ...
                  Rechtsgrundlagen: BGB, VOB/B, DSGVO
                </p>
              </div>
            </CardContent>
          </Card>
