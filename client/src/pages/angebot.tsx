...
export default function Angebot() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Estrich Angebot München kostenlos | Festpreis-Garantie | Estriche München Meisterbetrieb</title>
        <meta name="description" content="Estrich Angebot München kostenlos anfordern: Verbindlicher Festpreis in 24h, keine versteckten Kosten. Zementestrich ab 32€/m², Fließestrich ab 42€/m², Heizestrich vom Meisterbetrieb. Jetzt unverbindlich anfragen!" />
