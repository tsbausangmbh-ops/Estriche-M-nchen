    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-6 lg:py-8 overflow-hidden">
        <div 
          ...
          role="img"
          aria-label={`${article?.title || 'Estrich Ratgeber'} – Estrich Blog München`}
        ...
        <div className="page-container relative">
          <Link href="/ratgeber">
            <Button variant="ghost" className="mb-4 text-primary-foreground/80 hover:text-white hover:bg-white/10">
              <ChevronLeft className="mr-1 h-4 w-4" />
              Alle Artikel
            </Button>
          </Link>
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <Badge variant="secondary" className="border-primary-foreground/30 bg-primary-foreground/10 text-primary-foreground font-medium tracking-wide">
              {article.category}
            </Badge>
          ...
          <h1 className="text-xl sm:text-3xl lg:text-4xl lg:text-5xl font-extrabold text-white tracking-tight" data-testid="text-article-title">
            {article.title}
          </h1>
        </div>
      </section>
