...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Estrich FAQ München | Häufige Fragen Estrichleger beantwortet | Estriche München Ratgeber 2026</title>
        <meta name="description" content="Estrich FAQ München: Wie lange trocknet Estrich? Was kostet Estrich pro m²? Welcher Estrich für Fußbodenheizung? 25+ Experten-Antworten!" />
