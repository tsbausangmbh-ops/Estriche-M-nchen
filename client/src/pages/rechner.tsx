...
Hinweis: Diese Berechnung dient nur zur Orientierung. Der tatsächliche Preis wird nach einer Vor-Ort-Besichtigung ermittelt.
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Estrich Kosten pro m² München 2026 | Kostenrechner online | Estriche München Preise berechnen</title>
        <meta name="description" content="Estrich Kosten pro m² München 2026: Zementestrich ab 32€/m², Fließestrich ab 42€/m², Schnellestrich ab 48€/m². Kostenloser Rechner mit Festpreis!" />
